...
original_rom_64_md5 = '745e372bde611c2ceb3ec5db2bbeb77a'
dpad_rom_md5 = 'ac87bd6dd589586c37d533f1541c0de3'


def randomize(romData):
    dpad_patch = False
    if md5(romData).hexdigest() == original_rom_64_md5:
        dpad_patch = False
    elif md5(romData).hexdigest() == dpad_rom_md5:
        dpad_patch = True
    else:
        print(md5(romData).hexdigest())
        return False
